...
extension ProfileViewController {
    private func layout() {
        ...
        chatMyselfLabel.snp.makeConstraints{ make in
            ...
            make.leading.equalTo(self.chatMyselfButton).offset(20)
        }
        ...
        editProfileLabel.snp.makeConstraints{ make in
            ...
            make.leading.equalTo(self.editProfileButton).offset(20)
        }
        ...
        kakaoStoryLabel.snp.makeConstraints{make in
            ...
            make.leading.equalTo(self.kakaoStoryButton).offset(20)
